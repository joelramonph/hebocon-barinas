      ...
      <main className="min-h-screen bg-stone-50 flex flex-col items-center justify-center p-6">
        <div className="max-w-2xl w-full animate-in fade-in zoom-in duration-500">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-black uppercase italic text-black">¡Registro Exitoso!</h2>
            <p className="font-bold text-stone-500 uppercase">Descarga tu pase y muéstralo en la entrada.</p>
          </div>

          {/* TICKET DIGITAL PARA DESCARGAR */}
            ...
            <div className="bg-yellow-400 border-4 border-black p-1 flex flex-col md:flex-row shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
              <div className="p-8 border-b-4 md:border-b-0 md:border-r-4 border-black border-dashed bg-white flex-grow relative">
                ...
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="font-black uppercase italic text-sm tracking-tighter text-black">Hebocon Barinas 2026</span>
                </div>
                
                <h3 className="text-5xl font-black uppercase italic leading-none mb-6 text-black">PASE OFICIAL</h3>
                
                <div className="space-y-3 font-black uppercase text-sm italic">
                  <div className="flex flex-col text-black">
                    <span className="text-gray-400 text-xs">Invitado Especial:</span>
            ...
            <div className="bg-yellow-50 border-4 border-black p-6 mt-10 relative">
              ...
              <label className="flex items-start gap-4 cursor-pointer">
                ...
                <span className="font-bold text-sm leading-tight italic">
                  ¡Me apunto! Deseo recibir invitaciones exclusivas para los próximos <span className="text-blue-600 uppercase font-black">Talleres de Robótica e IA</span> del Profe Joel Parra.
                </span>
              </label>
            </div>
